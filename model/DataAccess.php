...
final class DataAccess {
   ...
   //Employee Promotions
    ...
    function checkout($date, $customerID, $destination, $totalPaid, $promoCode, $bookingType, $eventID, 
                        $ticketsBought, $registrationNumber, $startDate, $endDate)
    {
        ...
        $statement->execute([$date, $customerID, $destination, $totalPaid, $promoCode, $bookingType, $eventID, 
        $ticketsBought, $registrationNumber, $startDate, $endDate]);
    }
